 ...
 *
 * Responsible for holding all available stocks,
 * handling purchases and sales, and advancing the market week by week.
 *
 * Stocks are stored in a map using their symbol as key.
...
public class Exchange {
     ...
     *
     * The exchange is initialized with a name and a list of available stocks.
    ...
    public Exchange(String name, List<Stock> stocks) {
        ...
        for (Stock stock : stocks) {
            if (stock == null) throw new IllegalArgumentException("Stock list cannot contain null.");
     ...
     *
     * The week increases each time advance() is called.
     *
     ...
     *
     * A stock matches if the search term is contained in either
     ...
     *
     * A new Share is created with the current sales price of the stock.
     ...
     *
     * The sale is executed through a Sale transaction which is committed.
     *
